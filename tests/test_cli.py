...
class CLIDefaultTests(unittest.TestCase):
    ...
    def test_semantic_qwen_demo_defaults_to_complete_answer_scope(self) -> None:
        ...
        self.assertEqual(args.semantic_scope, DEFAULT_SEMANTIC_SCOPE)
        self.assertEqual(args.semantic_scope, "answer")
        self.assertEqual(args.context_paragraphs, 1)
        self.assertEqual(args.max_answer_passes, 4)
        self.assertEqual(args.max_new_tokens, 128)

    def test_semantic_qwen_demo_accepts_paragraph_scope(self) -> None:
        ...
        self.assertEqual(args.semantic_scope, "paragraph")
        self.assertEqual(args.context_paragraphs, 2)

    def test_semantic_detect_uses_same_scope_defaults(self) -> None:
